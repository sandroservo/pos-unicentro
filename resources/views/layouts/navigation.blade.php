            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img src="{{ asset('images/unicentroma.png') }}" alt="Logo da Unibdc" 
     class="block h-14 w-auto mx-auto " />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('processos.index')" :active="request()->routeIs('processos.index')">
                        {{ __('Seletivo') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
